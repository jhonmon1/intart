...
public class Reversi extends _Juego {
	...
	{
		return (tablero.esFinal() && tablero.fichasBlancas() == tablero.fichasNegras());
	}
	...
	private class EstadoReversi implements Estado {
		...
		/**
		 * Método que se encarga de devolver el estado del 
		 * juego luego de aplicar un movimiento
		...
		{
			return 	resultado(jugador.equals(jugadores[0]) ? nombreJugadorNegras : nombreJugadorBlancas);
		}
	...
	public static void main(String[] args) throws Exception 
	{
		System.out.println(Partida.completa(Reversi.JUEGO, 
				new AgenteConsola(), new AgenteAleatorio()
			).toString());
	}
}
